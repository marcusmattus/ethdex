...
<html lang="en">
<head>
    <title>Code coverage report for ChannelStore.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> ChannelStore.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import addons from '@storybook/addons';
&nbsp;
const GLOBAL = 'global';
&nbsp;
...
&nbsp;
    name = 'store',
    initData = {},
    isPanel = <span class="branch-0 cbranch-no" title="branch not covered" >false,</span>
    storyId,
  }) {
...
&nbsp;
    this.store = {
      [GLOBAL]: { init: this.initData || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> over: {} },
    };
  }
&nbsp;
&nbsp;
  selectorId = null;
&nbsp;
  subscriber = <span class="fstat-no" title="function not covered" >()</span> =&gt; {};
  onConnectedFn = () =&gt; {};
&nbsp;
...
&nbsp;
  init = <span class="fstat-no" title="function not covered" >da</span>ta =&gt; <span class="cstat-no" title="statement not covered" >this.channel.emit(this.EVENT_ID_INIT, { data, id: this.id });</span>
&nbsp;
  removeInit = () =&gt;
...
&nbsp;
  defaultReducer = <span class="fstat-no" title="function not covered" >(s</span>tore, payload) =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
    ...store,
    ...payload,
  });
&nbsp;
  _createAction = (reducer, getSubId) =&gt; {
    return async payload =&gt; {
      ...
      const over = await (reducer || <span class="branch-1 cbranch-no" title="branch not covered" >this.defaultReducer)</span>(current, payload);
      subData.over = over;
&nbsp;
      this.send();
      this.subscriber();
...
&nbsp;
  createLocalAction = <span class="fstat-no" title="function not covered" >re</span>ducer =&gt;
<span class="cstat-no" title="statement not covered" >    this._createAction(reducer, <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >this.selectorId || this.id)</span>;</span>
&nbsp;
  sendInit = <span class="fstat-no" title="function not covered" >da</span>ta =&gt; {
<span class="cstat-no" title="statement not covered" >    this.init(data);</span>
  };
&nbsp;
  disconnect = () =&gt; {
    this.removeInit();
...
&nbsp;
export const getNewStore =  <span class="fstat-no" title="function not covered" >(.</span>..args) =&gt; {
<span class="cstat-no" title="statement not covered" >  return new ChannelStore(...args);</span>
};</pre></td></tr>
</table></pre>
